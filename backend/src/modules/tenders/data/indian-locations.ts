...
/**
 * Words that are city/district names but also common English/Hindi words.
 * These will be excluded from PDF text search to avoid false matches.
 */
export const AMBIGUOUS_LOCATION_NAMES = new Set([
    "ALONG", "MON", "MANDI", "HASSAN", "PATAN", "SAGAR", "UNA", "PONDA", "DANG", "NUH", "MAU", "ANGUL", "BASTI", "BANDA", "ETAH", "DIU", "DHAR", "SAMBA",
]);
