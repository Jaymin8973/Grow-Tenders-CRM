    ...
    async handleHourlyTenderAlerts() {
        ...
        for (const tender of newTenders) {
            for (const sub of activeSubscriptions) {
                ...
                const documentLink = `https://grow-tender.com/tenders/${tender.id}/download-pdf`;
                const viewLink = `https://grow-tender.com/tenders/${tender.id}`;
                        ...
                        <div class="email-container" style="max-width: 600px; margin: 0 auto; padding: 15px;">
                            ...
                            <div style="background: #ffffff; padding: 20px; border: 1px solid #e2e8f0; border-top: none;">
                                ...
                                <div class="button-container" style="text-align: center; margin: 25px 0;">
                                    <a href="${viewLink}" class="button" style="display: inline-block; background-color: #2563eb; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 14px; margin-right: 8px;">
                                        📄 View Details
                                    </a>
                                    <a href="${documentLink}" class="button" style="display: inline-block; background-color: #059669; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 14px;">
                                        📥 Download PDF
                                    </a>
                                </div>
