    ...
    ({ className, label, error, icon, ...props }, ref) => {
        return (
            <div className="w-full space-y-1.5">
                ...
                {error && (
                    <p className="text-xs text-red-500 mt-1 animate-in slide-in-from-top-1 fade-in">{error}</p>
                )}
            </div>
        );
    }
